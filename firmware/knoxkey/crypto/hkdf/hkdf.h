#ifndef knoxkey_HKDF_H
#define knoxkey_HKDF_H
 ...
 * @param [in] okm_length the desired length of the okm in bytes, must be <= 255 * knoxkey_SHA256_OUTPUT_SIZE,
