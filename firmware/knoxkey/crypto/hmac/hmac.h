#ifndef knoxkey_HMAC_H
#define knoxkey_HMAC_H
 ...
 *
 * @param [in,out] ctx the HMAC context
 * @param [out] hmac the computed hmac digest, must be a buffer of knoxkey_SHA256_OUTPUT_SIZE bytes
 */
void hmac_final(void *ctx, uint8_t *hmac);

#endif // knoxkey_HMAC_H
