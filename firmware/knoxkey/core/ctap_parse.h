#ifndef knoxkey_CTAP_PARSE_H
#define knoxkey_CTAP_PARSE_H
...
// We chose this limit in our implementation (knoxkey) to simplify operations with RP IDs
...
// We chose this limit in our implementation (knoxkey) since we know that any Credential ID
