#ifndef knoxkey_CTAP_PIN_UV_AUTH_TOKEN_STATE_H
#define knoxkey_CTAP_PIN_UV_AUTH_TOKEN_STATE_H
...
typedef struct ctap_pin_uv_auth_token_state {
	 ...
	 * knoxkey currently does not support any built-in user verification method (thus it does not implement
...
#endif // knoxkey_CTAP_PIN_UV_AUTH_TOKEN_STATE_H
