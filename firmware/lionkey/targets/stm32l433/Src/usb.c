/**
 * @file    usb.c
 * @brief   USB initialization and HID task — Knox Key stm32l433
 *
 * Uses TinyUSB with the stm32_fsdev driver. The stm32l433 has an integrated
...
/* Reduced queue depth to save RAM on the 16KB stm32l433.
